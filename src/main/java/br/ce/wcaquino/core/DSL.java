...
public class DSL {
	...
	public void clicarBotaoTabela (String colunaBusca, String valor, String colunaBotao, String idTabela) {
		...
		WebElement celuna = tabela.findElement(By.xpath(".//tr["+idLinha+"]/td["+idColunaBotao+"]"));
		celuna.findElement(By.xpath(".//input")).click();
	}
